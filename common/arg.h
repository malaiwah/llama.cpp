...
#define COMMON_ARG_PRESET_KV_CACHE_ON_UNLOAD    "__PRESET_KV_CACHE_ON_UNLOAD"
#define COMMON_ARG_PRESET_KV_CACHE_ON_LOAD      "__PRESET_KV_CACHE_ON_LOAD"
...
struct common_arg {
    ...
    common_arg(const std::initializer_list<const char *> & args,
    ...
    common_arg(const std::initializer_list<const char *> & args,
        ...
        args(args),
        value_hint(value_hint),
        value_hint_2(value_hint_2),
        help(help),
        handler_str_str(handler) {}
