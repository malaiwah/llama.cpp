...
enum server_task_type {
    ...
    SERVER_TASK_TYPE_SLOT_SAVE_ALL,
    SERVER_TASK_TYPE_SLOT_RESTORE_ALL,
...
struct server_task {
    ...
    // used by SERVER_TASK_TYPE_SLOT_SAVE_ALL, SERVER_TASK_TYPE_SLOT_RESTORE_ALL
    struct slot_save_all_action {
        std::string persist_path;  // directory to save/restore all slots
    };

    slot_save_all_action slot_save_all_action;
